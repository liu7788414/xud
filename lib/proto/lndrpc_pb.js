 ...
 * @const
 */
proto.lnrpc.FeeLimit.oneofGroups_ = [[1,2]];
...
proto.lnrpc.NewWitnessAddressRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.lnrpc.NewWitnessAddressRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
...
proto.lnrpc.GetInfoResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    chainsList: jspb.Message.getRepeatedField(msg, 11),
 ...
 * @param {number=} opt_index
 */
proto.lnrpc.GetInfoResponse.prototype.addChains = function(value, opt_index) {
...
/**
 * optional uint32 num_max_invoices = 5;
 * @return {number}
 */
...
/**
 * optional uint32 last_index_offset = 2;
 * @return {number}
 */
