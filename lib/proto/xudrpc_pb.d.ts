...
export class AddCurrencyRequest extends jspb.Message { 
    ...
    getNetworkClient(): AddCurrencyRequest.NetworkClient;
    setNetworkClient(value: AddCurrencyRequest.NetworkClient): void;

    getTokenAddress(): string;
    setTokenAddress(value: string): void;

    getSubunits(): number;
    setSubunits(value: number): void;
...
export namespace AddCurrencyRequest {
    export type AsObject = {
        currency: string,
        networkClient: AddCurrencyRequest.NetworkClient,
        tokenAddress: string,
        subunits: number,
    }
